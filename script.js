...
const emojis = [''];
const titleTwo = "Pot de départ"
, dateTwo = new Date('2025-01-31T17:30:00')
, emojisTwo = ['🧳', '✈'];
const titleThree = "Chandeleur"
, dateThree = new Date('2025-02-02T00:00:00')
, emojisThree = ['🥞','❄','🧈'];
const titleFour = "Saint Patrick"
, dateFour = new Date('2025-03-17T00:00:00')
, emojisFour = ['🍻','🍺','🥃', '☘'];
const titleFive = "Anniversaire Lucie"
, dateFive = new Date('2025-04-26T00:00:00')
, emojisFive = ['🎉','🎂','🎁'];
