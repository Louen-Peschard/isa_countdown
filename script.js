...
const emojis = [''];
const titleTwo = "Toussaint (lendemain)"
, dateTwo = new Date('2024-10-31T17:30:00')
, emojisTwo = ['🎉', '🏖', '✈'];
const titleThree = "Noël"
, dateThree = new Date('2024-12-25T00:00:00')
, emojisThree = ['🎊','❄','🎄','🎁'];
const titleFour = "Nouvel-an"
, dateFour = new Date('2025-01-01T00:00:00')
, emojisFour = ['🎆','✨','🍾', '🎉'];
