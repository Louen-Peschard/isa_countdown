...
const emojis = [''];
const titleTwo = "Retour potentiel de Mathilde"
, dateTwo = new Date('2025-10-01T08:30:00')
, emojisTwo = ['🎉', '👶'];
const titleThree = "Le grand remplacement de Isa-Rennes"
, dateThree = new Date('2025-07-07T08:30:00')
, emojisThree = ['☮','🔪','😭'];
const titleFour = "Test laximétrie flessum"
, dateFour = new Date('2025-07-22T14:45:00')
, emojisFour = ['⛑','🦵','🦴', '🩺'];
const titleFive = "Anniversaire Lucie"
, dateFive = new Date('2026-04-26T00:00:00')
, emojisFive = ['🎉','🎂','🎁'];
